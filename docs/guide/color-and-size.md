...
Click **"+ new group"**, pick a color, give it a name, and add criteria the same way as [Filter](./filter) - Text, Tag, Property, Folder, Filename, Not edited at least, Activity, Minimum number of links - including each criterion's own include/exclude word.
