...
export default defineConfig({
  title: 'Clew',
  description: 'The Knowledge Explorer for Obsidian - hub, bridge, community, and semantic-cluster analytics plus smart filters, not just a prettier graph.',
  lang: 'en-US',
  ...
  head: [
    ...
    ['meta', { property: 'og:description', content: 'Hub, bridge, community, and semantic-cluster analytics plus smart filters - understand how your vault connects, not just draw it.' }],
  ...
  themeConfig: {
    ...
    // (Layout, Filter, Color & size, Find path, Focus, Timeline,
    // Appearance, Diagnostics, Views), then how you interact with the
    // graph itself.
    sidebar: [
      {
        text: 'Introduction',
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Find path', link: '/guide/find-path' },
